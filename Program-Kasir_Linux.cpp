...
int main(){																					
	system("clear");											//fungsi untuk membersihkan data di command tanpa menutup program
	cout << "==================="<<endl;						//output
...
void menu(){															//memberikan logic pada function menu
	system("clear");													//fungsi untuk membersihkan
...
void struk(){													//memberikan logic pada fungsi struk
	system("clear");											//fungsi untuk membersihkan layar
